...
/**
 * This is the controller class for Severity Microservice.
 * It contains one endpoint health-check,ProjectExecutionStatus.
 * @author Rupesh Lal
 *
 */
@RestController
...
public class AuditSeverityController {
	 ...
	 * @return a string message to user
	 */
	 ...
	 * @param jwt is the Jwt token
	 * @param auditRequest is the object of AuditRequest model class.
	 * @return response is the http response if the token is validated then it returns 
	 * HttpStatus.OK else it returns HttpStatus.FORBIDDEN
	 */

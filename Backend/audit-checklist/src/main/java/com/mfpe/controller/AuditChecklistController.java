...
@CrossOrigin(origins = "*")
/**
 *This is the controller class for Checklist Microservice.
 * It contains one endpoint health-check,AuditCheckListQuestions.
 * 
 * @author Shifa Mirza
 *
 */
public class AuditChecklistController {
	 ...
	 * @return list of questions according to the AuditType selected
	 */
	 ...
	 * @return Http response with status Active.
	 * 
	 */

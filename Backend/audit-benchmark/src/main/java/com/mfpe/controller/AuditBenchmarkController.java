...
/**
 *  
 * AuditBenchmarkController class  will handle the web request
 *
 */
@RestController
...
public class AuditBenchmarkController {
	 ...
	 * @param jwt  is an open standard used to share security information between two parties  a client and a server 
	 ...
	 * @return the audit benchmark microservice is active or not
	 */

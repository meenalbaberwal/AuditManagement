 ...
 * It contains three endpoints health-check , authorization and validate .
 * 
 * @author Rupesh Lal
 *
 */
...
public class AuthController {
	...
	/**
	 * 
	 * This method is used to check that the microservice is running.
	 * @return Http response with status OK and a message to user.
	 * 
	 */
	// for Health check [PERMITTED FOR ALL]
	...
	/**
	 * 
	 * This method is used to authenticate user using username and password and throws exception if not valid user 
	 * @param request is object of AuthenticationRequest model class which contains username and password
	...
	/**
	 * 
	 * This method is used to validate user-credentials for every request triggered by the user
	 * and throws exception if user-credentials are invalid
	 * @param jwt is the token used to validate user-credentials
	 * @return response which is the object of AuthenticationResponse model class
	 */
